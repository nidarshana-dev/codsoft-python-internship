...
**Description:**  
A command-line To-Do List app to create, update, and track daily tasks efficiently. Users can add tasks, view all tasks, update, delete, and mark tasks as completed.
